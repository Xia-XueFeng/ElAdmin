<template>
    <div>
      ...
      <el-card>
        ...
        <!--表格-->
        <zk-table class="zkTable" :data="catelist" :columns="columns" :selection-type="false"
      ...
      <el-dialog title="修改分类" :visible.sync="editCateDialogVisible" width="50%">
        <el-form :model="editCateForm" :rules="editCateFormRules" ref="editCateFormRef" label-width="70px">
          <el-form-item label="分类名称">
            <el-input v-model="editCateForm.cat_name" prop="cat_name1"></el-input>
          </el-form-item>
        </el-form>
        <span slot="footer" class="dialog-footer">
    ...
    export default {
          ...
          return {
            ...
            editCateFormRules:{
              cat_name1: [
                ...
                {
                  min: 3, max: 10, message: '分类名的长度在3~10个字符之间',
                  trigger: 'blur'
                }
              ]
            },
      ...
      methods:{
        ...
        parentCateChanged() {
          ...
          //如果selectedKeys数组中的lenth大于0，证明选中父级分类
          //反之，就说明没有选中任何父级分类
        ...
        //点击按钮修改分类名称
        editCate() {
          console.log(this.cateId+'---'+this.editCateForm.cat_name)
